...
- (void)loadfaceSubjectPickerSource:(NSArray *)pickerSource
{
    for (int i = 0; i<pickerSource.count; i++) {
        ...
        btn.frame = CGRectMake(i*kFacePanelBottomToolBarItemWidth, 0, kFacePanelBottomToolBarItemWidth, kFacePanelBottomToolBarHeight);
...
{
    [_facePickerView setContentOffset:CGPointMake(subjectIndex*kFacePanelBottomToolBarItemWidth, 0) animated:YES];
